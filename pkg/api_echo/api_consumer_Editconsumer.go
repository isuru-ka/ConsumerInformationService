...
import (
	...
	arfeditconsumer "consumerinformationmodule/pkg/rule/ARF_EditConsumer"
...
// @Router /consumerinformationmodule/api/consumer [put]
func EditConsumer(c echo.Context) (*model.Consumer, error) {
	...
	config["_size"] = _size
	result, err := arfeditconsumer.ARF_EditConsumer(&consumer, &cntxt, config)
